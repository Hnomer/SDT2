...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnJoyWidgetConstructedEvent, bool, IsConstructed);
...
//~~~~~~~~~~~~~~
public:
	//Event to set color right after creation
	...
	UPROPERTY(BlueprintAssignable, Category = "Widget Event", meta = (DisplayName = "OnColorChanged (Joy Color Wheel)"))
		FOnJoyWidgetConstructedEvent OnColorWheelConstructed;
